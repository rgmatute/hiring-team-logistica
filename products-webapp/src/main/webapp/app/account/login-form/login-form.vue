    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-8">
        <b-form role="form" v-on:submit.prevent="doLogin()">
          <b-form-group v-bind:label="$t('global.form[\'email.label\']')" label-for="username">
            <b-form-input
              id="username"
              type="text"
              name="username"
          ...
          <div>
            <b-button class="btn-block" data-cy="submit" type="submit" variant="primary" v-text="$t('login.form.button')">Sign in</b-button>
          </div>
        </b-form>
        <p></p>
        <!-- <div>
